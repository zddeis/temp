                ...
                <div class="px-4 py-5 sm:p-6">
                    @if (isset($weather['current']))
                        <div class="flex items-center justify-between">
                            <div>
                                <form method="GET" action="{{ route('weather') }}" class="flex gap-2">
                    ...
                    @else
                        ...
                        <form method="GET" action="{{ route('weather') }}" class="mx-auto gap-2 max-w-xl py-24">
                            ...
                            <div class="flex">
                                <input type="text" name="location" id="location" value="{{ $location }}"
                                    placeholder="Enter city, country"
                                    class="rounded-md w-full bg-gray-100 py-2 px-4 text-2xl text-gray-900">
                                <button type="submit" class="rounded-md pb-1 px-4 text-3xl text-gray-900 hover:text-gray-700">
                                    ⟳
                                </button>
                            </div>
                        </form>
